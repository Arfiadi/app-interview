...
export default function InterviewPage() {
  ...
  return (
    <Layout title={`Sesi Interview • Soal ${currentIndex + 1}`}>
      ...
      {/* Container Utama: Diperlebar ke max-w-7xl */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
        ...
        {/* Grid Layout: 4 Kolom Kiri, 8 Kolom Kanan (Lebih Luas untuk Jawaban) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          
          {/* KOLOM KIRI (Pertanyaan): Sticky agar tetap terlihat saat scroll */}
          <div className="lg:col-span-4 lg:sticky lg:top-24 order-1 space-y-6">
            <QuestionCard question={currentQuestion} />
          </div>

          {/* KOLOM KANAN (Jawaban): Area Dominan */}
