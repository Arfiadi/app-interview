...
export default function ResultQuestionCard({ item, index }: ResultQuestionCardProps) {
          ...
          <div className="mt-auto pt-4 border-t border-gray-50 space-y-4">
             ...
             <div>
                ...
                <div className="flex flex-wrap gap-2">
                    {item.keywords?.user_keywords && item.keywords.user_keywords.length > 0 ? (
             ...
             <div>
                ...
                <div className="flex flex-wrap gap-2">
                    {item.keywords?.missing_keywords && item.keywords.missing_keywords.length > 0 ? (
          ...
          <div className="prose prose-sm prose-slate max-w-none relative z-10">
            <ReactMarkdown 
                components={{
                    ...
                    h3: ({node, ...props}: any) => <h3 className="text-sm font-bold text-primary mt-5 mb-2 uppercase tracking-wide border-b border-secondary/20 pb-1 inline-block" {...props} />,
                    strong: ({node, ...props}: any) => <span className="font-bold text-primary" {...props} />,
                    ul: ({node, ...props}: any) => <ul className="list-none pl-0 space-y-2 my-3" {...props} />,
                    li: ({node, ...props}: any) => (
                    ...
                    p: ({node, ...props}: any) => <p className="text-sm leading-relaxed mb-3 text-text-main" {...props} />,
